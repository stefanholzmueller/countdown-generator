...
(function(exports) {
  ...
  var printShortMonth = function (v) {
      ...
      throw new Error("Failed pattern match at Data.Formatter.DateTime line 441, column 19 - line 453, column 16: " + [ v.constructor.name ]);
  };                                                                                                                        
  ...
  var padSingleDigit = function (i) {
      ...
      throw new Error("Failed pattern match at Data.Formatter.DateTime line 184, column 1 - line 184, column 30: " + [ i.constructor.name ]);
  };
  var padQuadrupleDigit = function (i) {
      ...
      throw new Error("Failed pattern match at Data.Formatter.DateTime line 195, column 1 - line 195, column 33: " + [ i.constructor.name ]);
  };
  var padDoubleDigit = function (i) {
      ...
      throw new Error("Failed pattern match at Data.Formatter.DateTime line 189, column 1 - line 189, column 30: " + [ i.constructor.name ]);
  };                        
  var formatterCommandParser = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Data_Formatter_Parser_Utils.oneOfAs(Data_Functor.functorArray)(Data_Foldable.foldableArray)(Data_Identity.monadIdentity)(function ($447) {
      return Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)($447));
  ...
  var formatCommand = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof Meridiem) {
              var $349 = Data_Enum.fromEnum(Data_Time_Component.boundedEnumHour)(Data_Time.hour(v.value1)) >= 12;
              if ($349) {
                  return "PM";
              };
              return "AM";
          ...
          throw new Error("Failed pattern match at Data.Formatter.DateTime line 159, column 38 - line 180, column 20: " + [ v1.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var Data_Time_Duration = PS["Data.Time.Duration"];
  var Prelude = PS["Prelude"];        
  var weekendStartHour = 17;
  var weekendStartDayOfWeek = 5;
  var offset = Data_Functor.map(Control_Monad_Eff.functorEff)(function (v) {
      return Data_Ring.negate(Data_Time_Duration.ringMinutes)(v.value1);
  })(Control_Monad_Eff_Now.locale);
  var currentLocalTime = (function () {
      var effMaybeDateTime = Control_Apply.lift2(Control_Monad_Eff.applyEff)(Data_DateTime.adjust(Data_Time_Duration.durationMinutes))(offset)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_DateTime_Instant.toDateTime)(Control_Monad_Eff_Now.now));
      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.fromMaybe(Data_Bounded.bottom(Data_DateTime.boundedDateTime)))(effMaybeDateTime);
  })();
  var durationTillWeekend = (function () {
      var testWeekend = function (now) {
          var timeFormatter = {
              comma: false, 
              before: 2, 
              after: 0, 
          ...
          var dayOfWeek = Data_Enum.fromEnum(Data_Date_Component.boundedEnumWeekday)(Data_Date.weekday(Data_DateTime.date(now)));
          var dayDiff = Data_Time_Duration.Days(Data_Int.toNumber(weekendStartDayOfWeek - dayOfWeek | 0));
          var startDate = Data_Maybe.fromMaybe(Data_Bounded.bottom(Data_DateTime.boundedDateTime))(Data_DateTime.adjust(Data_Time_Duration.durationDays)(dayDiff)(now));
          var startDatetime = Data_DateTime.modifyTime(function ($6) {
              return (function ($7) {
                  return Data_Time.setMillisecond(Data_Maybe.fromMaybe(Data_Bounded.bottom(Data_Time_Component.boundedMillisecond))(Data_Enum.toEnum(Data_Time_Component.boundedEnumMillisecond)(0)))(Data_Time.setSecond(Data_Maybe.fromMaybe(Data_Bounded.bottom(Data_Time_Component.boundedSecond))(Data_Enum.toEnum(Data_Time_Component.boundedEnumSecond)(0)))($7));
              })(Data_Time.setMinute(Data_Maybe.fromMaybe(Data_Bounded.bottom(Data_Time_Component.boundedMinute))(Data_Enum.toEnum(Data_Time_Component.boundedEnumMinute)(0)))(Data_Time.setHour(Data_Maybe.fromMaybe(Data_Bounded.bottom(Data_Time_Component.boundedHour))(Data_Enum.toEnum(Data_Time_Component.boundedEnumHour)(weekendStartHour)))($6)));
          })(startDate);
          var diffMillis = Data_DateTime.diff(Data_Time_Duration.durationMilliseconds)(startDatetime)(now);
          var $4 = Data_Ord.lessThan(Data_DateTime.ordDateTime)(startDatetime)(now);
          if ($4) {
              return Data_Maybe.Nothing.value;
          };
          return new Data_Maybe.Just((function () {
              var d = Data_Time_Duration.convertDuration(Data_Time_Duration.durationMilliseconds)(Data_Time_Duration.durationDays)(diffMillis);
              var d$prime = Data_Int.floor(Data_Newtype.unwrap(Data_Time_Duration.newtypeDays)(d));
              var dd = Data_Show.show(Data_Show.showInt)(d$prime);
              var h = Data_Time_Duration.convertDuration(Data_Time_Duration.durationDays)(Data_Time_Duration.durationHours)(Data_Ring.sub(Data_Time_Duration.ringDays)(d)(Data_Time_Duration.Days(Data_Int.toNumber(d$prime))));
              var h$prime = Data_Int.toNumber(Data_Int.floor(Data_Newtype.unwrap(Data_Time_Duration.newtypeHours)(h)));
              var hh = Data_Formatter_Number.format(timeFormatter)(h$prime);
              var m = Data_Time_Duration.convertDuration(Data_Time_Duration.durationHours)(Data_Time_Duration.durationMinutes)(Data_Ring.sub(Data_Time_Duration.ringHours)(h)(h$prime));
              var m$prime = Data_Int.toNumber(Data_Int.floor(Data_Newtype.unwrap(Data_Time_Duration.newtypeMinutes)(m)));
              var mm = Data_Formatter_Number.format(timeFormatter)(m$prime);
              var s = Data_Time_Duration.convertDuration(Data_Time_Duration.durationMinutes)(Data_Time_Duration.durationSeconds)(Data_Ring.sub(Data_Time_Duration.ringMinutes)(m)(m$prime));
              var s$prime = Data_Int.toNumber(Data_Int.floor(Data_Newtype.unwrap(Data_Time_Duration.newtypeSeconds)(s)));
              var ss = Data_Formatter_Number.format(timeFormatter)(s$prime);
              return (function () {
                  var $5 = d$prime > 0;
                  if ($5) {
                      return dd + " days and ";
      ...
      return Data_Functor.map(Control_Monad_Eff.functorEff)(testWeekend)(currentLocalTime);
  })();
  var isWeekend = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.isNothing)(durationTillWeekend);
  var formattedCurrentTime = (function () {
      var toString = function (dateTime) {
          var workaroundForWeekday = Data_Show.show(Data_Date_Component.showWeekday)(Data_Date.weekday(Data_DateTime.date(dateTime)));
          var formattedDate = Data_Either.either(Data_Function["const"]("ERROR"))(Control_Category.id(Control_Category.categoryFn))(Data_Formatter_DateTime.formatDateTime("HH:mm")(dateTime));
          return workaroundForWeekday + (", " + formattedDate);
      };
      return Data_Functor.map(Control_Monad_Eff.functorEff)(toString)(currentLocalTime);
  })();
  exports["currentLocalTime"] = currentLocalTime;
  exports["durationTillWeekend"] = durationTillWeekend;
  exports["formattedCurrentTime"] = formattedCurrentTime;
  exports["isWeekend"] = isWeekend;
  exports["offset"] = offset;
  exports["weekendStartDayOfWeek"] = weekendStartDayOfWeek;
  exports["weekendStartHour"] = weekendStartHour;
})(PS["Weekend"] = PS["Weekend"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Bind = PS["Control.Bind"];
  ...
  var component = (function () {
      var render = function (state) {
          if (state.isWeekend) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("rainbow") ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.class_("time") ])([ Halogen_HTML_Core.text("It's " + state.currentTime) ]), Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.class_("weekend") ])([ Halogen_HTML_Core.text("WEEKEND") ]) ]);
          };
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.class_("time") ])([ Halogen_HTML_Core.text("It's " + state.currentTime) ]), Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.class_("countdown") ])([ Halogen_HTML_Core.text("Weekend starts in"), Halogen_HTML_Elements.br_, Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")(state.duration)) ]) ]);
      };
      var initialState = {
          isWeekend: false, 
          currentTime: "", 
      ...
      var $$eval = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.delay(100.0)))(function () {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Weekend.formattedCurrentTime))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Weekend.isWeekend))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Weekend.durationTillWeekend))(function (v3) {
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Component.component)(Data_Unit.unit)(v))(function (v1) {
          return Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffAff)(v1.query(Halogen_Query.action(Component.Tick.create)));
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
