...
(function(exports) {
  ...
  var Itemized = (function () {
      function Itemized(value0) {
          this.value0 = value0;
      };
      Itemized.create = function (value0) {
          return new Itemized(value0);
      };
      return Itemized;
  })();
  var weekendStartTime = Data_Maybe.fromJust()(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Time.Time.create)(Data_Enum.toEnum(Data_Time_Component.boundedEnumHour)(17)))(Data_Enum.toEnum(Data_Time_Component.boundedEnumMinute)(0)))(Data_Enum.toEnum(Data_Time_Component.boundedEnumSecond)(0)))(Data_Enum.toEnum(Data_Time_Component.boundedEnumMillisecond)(0)));
  ...
  var durationItemized = new Data_Time_Duration.Duration(function (v) {
      var msInMinute = 60 * 1000 | 0;
      var msInHour = 60 * msInMinute | 0;
      var msInDay = 24 * msInHour | 0;
      return Data_Int.toNumber((((v.value0.days * msInDay | 0) + (v.value0.hours * msInHour | 0) | 0) + (v.value0.minutes * msInMinute | 0) | 0) + (v.value0.seconds * 1000 | 0) | 0) + v.value0.ms;
  }, function (v) {
      var toInt = function (n) {
          return Data_Maybe.fromJust()(Data_Int.fromNumber(n));
      };
      var divMod = function (x) {
          return function (y) {
              return new Data_Tuple.Tuple($$Math.floor(x / y), $$Math.remainder(x)(y));
          };
      };
      var v1 = divMod(v)(1000.0);
      var v2 = divMod(v1.value0)(60.0);
      var v3 = divMod(v2.value0)(60.0);
      var v4 = divMod(v3.value0)(24.0);
      var seconds = toInt(v2.value1);
      var minutes = toInt(v3.value1);
    
      // Number.MAX_SAFE_INTEGER / 86400000 is smaller than 2^31
  var hours = toInt(v4.value1);
      var days = toInt(v4.value0);
      return new Itemized({
          days: days, 
          hours: hours, 
          minutes: minutes, 
  ...
  var durationTillWeekend = (function () {
      var testWeekend = function (now) {
          ...
          var countdownEnd = Data_DateTime.modifyTime(Data_Function["const"](weekendStartTime))(startDate);
          var $36 = Data_Ord.lessThan(Data_DateTime.ordDateTime)(countdownEnd)(now);
          if ($36) {
              return Data_Maybe.Nothing.value;
          };
          var difference = Data_DateTime.diff(durationItemized)(countdownEnd)(now);
          var formatTime = function (t) {
              var $38 = t < 10;
              if ($38) {
                  return "0" + Data_Show.show(Data_Show.showInt)(t);
              };
              return Data_Show.show(Data_Show.showInt)(t);
          };
          var hh = formatTime(difference.value0.hours);
          var mm = formatTime(difference.value0.minutes);
          var ss = formatTime(difference.value0.seconds);
          var dd = (function () {
              if (difference.value0.days === 0) {
                  return "";
              };
              if (difference.value0.days === 1) {
                  return "1 day and ";
              };
              return Data_Show.show(Data_Show.showInt)(difference.value0.days) + " days and ";
          })();
          return Data_Maybe.Just.create(dd + (hh + (":" + (mm + (":" + ss)))));
      };
  ...
  exports["weekendStartTime"] = weekendStartTime;
  exports["durationItemized"] = durationItemized;
